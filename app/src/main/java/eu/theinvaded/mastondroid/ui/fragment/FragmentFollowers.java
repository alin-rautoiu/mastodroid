...
public class FragmentFollowers extends Fragment implements FollowersViewModelContract.FollowersView{
    ...
    private FollowersViewModel timelineViewModel;
    ...
    private void initDataBinding() {
        ...
        timelineViewModel = new FollowersViewModel(this, bundle.getLong(USER_ID), bundle.getInt(TYPE));
        timelineViewModel.populateList();
    }
